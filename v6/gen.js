...
if (config.UKRAINIAN_LETTERS) list += "абвгґдеєжзиіїйклмнопрстуфхцчшщьюя";
if (config.UKRAINIAN_CAPITAL_LETTERS) list += "АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ";
...
if (
  ...
  !config.UKRAINIAN_LETTERS &&
  !config.UKRAINIAN_CAPITAL_LETTERS &&
  !config.NUMBERS &&
  !config.SYMBOLS
) {
